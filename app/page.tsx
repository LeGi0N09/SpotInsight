          ...
          {loading ? (
            ...
            <>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 mb-6 animate-fadeIn">
                <KPI
                  title="Total Plays"
                  value={(stats.totalPlays as number) || 0}
                  subtitle="All time listening"
                />
                <KPI
                  title="This Month"
                  value={monthly.slice(-1)[0]?.plays || 0}
                  subtitle="Current month plays"
                />
                <KPI
                  title="Artists"
                  value={
                    (stats.topArtists as unknown[] | undefined)?.length || 0
                  }
              ...
              {/* Charts Row */}
              <div
                className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6 animate-fadeIn"
                    ...
                    <div>
                      ...
                      {monthly.length >= 2 &&
                        (() => {
                          ...
                          const previous =
                            recent[recent.length - 2]?.plays || 1;
                          const growth = (
                          ...
                          return (
                            <div
                              className={`text-xs mt-1 ${
                                isPositive ? "text-[#00e461]" : "text-red-400"
                              }`}
                            >
                              {isPositive ? "↑" : "↓"}{" "}
                  ...
                  <div className="relative h-52">
                    {hoveredMonth && (
                      <div className="absolute top-0 left-1/2 -translate-x-1/2 bg-[#1a1a1a] px-3 py-2 rounded-lg shadow-lg z-10 border border-[#00e461]">
                        ...
                        <div className="text-sm font-bold text-[#00e461]">
                          {hoveredMonth.plays.toLocaleString()} plays
                        </div>
                      </div>
                    )}
                    {monthly.length > 0 &&
              ...
              {/* Summary Cards */}
              <div
                className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-4 animate-fadeIn"
              ...
              >
                <div className="bg-[#111111] rounded-2xl p-4">
                  ...
                  <div className="text-xl font-bold truncate">
                    {stats.topTracks?.[0]?.name || "N/A"}
                  </div>
                  <div className="text-xs opacity-60 truncate mb-3">
                    {stats.topTracks?.[0]?.artist || ""}
                  </div>
                ...
                <div className="bg-[#111111] rounded-2xl p-4">
                  ...
                  <div className="text-xs opacity-60 mb-3">
                    {stats.topArtists?.[0]?.followers?.toLocaleString() || 0}{" "}
                    followers
                  </div>
                  <div className="space-y-2 mt-3 pt-3 border-t border-[#1a1a1a]">
                            ...
                            return (
                              <div key={i}>
                                ...
                                <div className="w-full bg-[#1a1a1a] rounded-full h-1.5">
                                  <div
                                    className="bg-[#00e461] h-1.5 rounded-full transition-all"
